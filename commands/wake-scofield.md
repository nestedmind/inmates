...
2. Look for `.inmates/config.md` in the project in the current directory.
   - If it does not exist, follow the `onboarding` skill first.
   - If it exists, read it and `.inmates/status.md`, check the issue tracker against them, and report where things stand before you spend anything. GitHub is the truth when they disagree.
