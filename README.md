...
- A project board: GitHub Projects is the tested board. Linear through its MCP server is untested, and [#72](https://github.com/nestedmind/inmates/issues/72) is testing it.
