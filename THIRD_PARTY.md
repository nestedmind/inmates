...
- `skills/verification-before-completion/`, adapted from `skills/verification-before-completion/SKILL.md` upstream. Changes: removed the emphasis and code-fence formatting, tightened the tables, and added a related-skills note that ties it to `receiving-code-review` and a future `copilot-pr-review`.
